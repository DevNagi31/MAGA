    ...
    <View style={[styles.container, { paddingTop: insets.top + 40, paddingBottom: insets.bottom }]}>
      ...
      <Animated.View style={[styles.content, contentStyle]}>
        ...
        <View style={styles.summary}>
          <SummaryRow label="Essentials (Needs)" amount={allocs.needs} color="#60A5FA" icon="home" />
          <SummaryRow label="Lifestyle (Wants)" amount={allocs.wants} color="#A78BFA" icon="heart" />
          <SummaryRow label="Savings Target" amount={allocs.savings} color="#34D399" icon="trending-up" />
        </View>
      </Animated.View>
...
const SummaryRow = ({ label, amount, color, icon }) => (
